...
export default function UserVisitor() {
  ...
  .filter(v => v.visitorPurpose !== "DELIVERY") // 👈 DELIVERY hata diya
  .filter((v) => {
          ...
          {filteredVisitors.map((v) => (
            ...
            >
              ...
              <div className="mt-3 text-xs text-gray-600 space-y-1">
                ...
                {v.visitorPurpose !== "GUEST" && (
                  <p>Company: {v.companyName || "-"}</p>
                )}
